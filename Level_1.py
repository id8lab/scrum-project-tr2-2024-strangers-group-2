...
pygame.display.set_caption('Desert Adventure 2')
...
with open(f'level2_data.csv{level}_data.csv', newline='') as csvfile:
...
desert_mountain = pygame.transform.scale(pygame.image.load(os.path.join("Assets", "desert_mountain.png")),
                                         (screen_width, screen_height // 1.5))
desert_sky = pygame.transform.scale(pygame.image.load(os.path.join("Assets", "desert_sky.png")),
                                    (screen_width, screen_height // 1.5))
pine1 = pygame.transform.scale(pygame.image.load(os.path.join("Assets", "img_background", "pine1.png")),
                               (screen_width, screen_height // 1.8))
pine2 = pygame.transform.scale(pygame.image.load(os.path.join("Assets", "img_background", "pine2.png")),
                               (screen_width, screen_height // 1.8))
heart_image = pygame.transform.scale(pygame.image.load(
    os.path.join("Assets", "minecraft-story-mode-pixel-art-video-games-minecraft-heart-removebg-preview.png")),
    (40, 40))
heart_size = (40, 40)

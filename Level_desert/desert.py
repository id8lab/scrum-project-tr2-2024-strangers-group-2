...
# Background
background = pygame.transform.scale(pygame.image.load(os.path.join("Assets", "Tower.png")), (win_width, win_height))

# Music/Sounds
music = pygame.mixer.music.load(os.path.join("Assets/Audio", "game-level.wav"))

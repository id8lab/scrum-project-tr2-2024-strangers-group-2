...
start_button = button.Button(center_x - button_width // 2, 400, start_img, 1)
...
def start_screen():
    ...
    screen.blit(game_title, ((screen_width - game_title.get_width()) // 2, (screen_height - game_title.get_height()) // 3.5))

...
# Heart
heart = pygame.transform.scale(pygame.image.load(os.path.join("Assets", "Heart.png")), (200, 200))
# Music/Sounds
pygame.mixer.music.load(os.path.join("Assets/Audio", "FrozenJam-SeamlessLoop.ogg"))
pop_sound = pygame.mixer.Sound(os.path.join("Assets/Audio", "ui 1.wav"))
...
def draw_game():
    ...
    if player.alive == False:
        ...
        if userInput[pygame.K_r]:
            ...
            speed = 2
    font = pygame.font.Font('freesansbold.ttf', 32)
    text = font.render('Lives: ' + str(player.lives) + ' | Heart Health: ' + str(heart) + ' |Kills: ' + str(kills), True,(0, 0, 0))

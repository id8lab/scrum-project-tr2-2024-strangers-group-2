...
# Add this line where you define player-related variables
enemies_killed = 0
...
with open(f'D:/scrum-project-tr2-2024-strangers-group-2/final/main/level{level}_data.csv', newline='') as csvfile:
...
resume_img = pygame.image.load("D:/scrum-project-tr2-2024-strangers-group-2/final/main/images/button_resume.png").convert_alpha()
options_img = pygame.image.load("D:/scrum-project-tr2-2024-strangers-group-2/final/main/images/button_options.png").convert_alpha()
quit_img = pygame.image.load("D:/scrum-project-tr2-2024-strangers-group-2/final/main/images/button_quit.png").convert_alpha()
video_img = pygame.image.load("D:/scrum-project-tr2-2024-strangers-group-2/final/main/images/button_video.png").convert_alpha()
audio_img = pygame.image.load("D:/scrum-project-tr2-2024-strangers-group-2/final/main/images/button_audio.png").convert_alpha()
keys_img = pygame.image.load("D:/scrum-project-tr2-2024-strangers-group-2/final/main/images/button_keys.png").convert_alpha()
back_img = pygame.image.load("D:/scrum-project-tr2-2024-strangers-group-2/final/main/images/button_back.png").convert_alpha()
restart_img = pygame.image.load("D:/scrum-project-tr2-2024-strangers-group-2/final/main/images/button_restart.png").convert_alpha()
start_img = pygame.image.load("D:/scrum-project-tr2-2024-strangers-group-2/final/main/images/button_start.png").convert_alpha()
mute_img = pygame.image.load("D:/scrum-project-tr2-2024-strangers-group-2/final/main/images/button_mute.png").convert_alpha()
unmute_img = pygame.image.load("D:/scrum-project-tr2-2024-strangers-group-2/final/main/images/button_unmute.png").convert_alpha()
...
quit_button = button.Button(center_x - button_width // 2, 600, quit_img, 1)
...
mute_button = button.Button(center_x - button_width // 2, 500, mute_img, 1)
unmute_img = button.Button(center_x - button_width // 2, 500, unmute_img, 1)
...
# Load images
sky_cloud = pygame.image.load('D:/scrum-project-tr2-2024-strangers-group-2/final/main/img_background/sky_cloud.png').convert_alpha()
mountain = pygame.image.load('D:/scrum-project-tr2-2024-strangers-group-2/final/main/img_background/mountain.png').convert_alpha()
pine1 = pygame.image.load('D:/scrum-project-tr2-2024-strangers-group-2/final/main/img_background/pine1.png').convert_alpha()
pine2 = pygame.image.load('D:/scrum-project-tr2-2024-strangers-group-2/final/main/img_background/pine2.png').convert_alpha()
heart_image = pygame.image.load('D:/scrum-project-tr2-2024-strangers-group-2/final/main/img_element/minecraft-story-mode-pixel-art-video-games-minecraft-heart-removebg-preview.png').convert_alpha()
...
# Load sound effects
shooting_sound = pygame.mixer.Sound('D:/scrum-project-tr2-2024-strangers-group-2/final/main/sounds/shooting.wav')
jump_sound = pygame.mixer.Sound('D:/scrum-project-tr2-2024-strangers-group-2/final/main/sounds/jump.wav')
game_over_sound = pygame.mixer.Sound('D:/scrum-project-tr2-2024-strangers-group-2/final/main/sounds/game-over-arcade-6435.mp3')

# Flag check
game_over_sound_flag = False
audio_settings_flag = False
...
def start_game():
    global level, player_lives, score, timer, scroll, moving_left, moving_right, game_paused, menu_state, enemies_killed
...
def audio_settings():
    ...
    if mute_button.draw(screen):
        if mute_button.is_pressed:
            pygame.mixer.pause()
    if unmute_img.draw(screen):
        if unmute_img.is_pressed:
...
class Laser(pygame.sprite.Sprite):
    def __init__(self, player, scroll, is_player, is_enemy):
        ...
        self.player = player
        self.rect.centerx = self.player.rect.centerx + scroll
        self.rect.centery = self.player.rect.centery
        self.speed = 9 * self.player.direction
    ...
    def check_collisions(self, laser_group,scroll):
            ...
            for laser in laser_group:
                if is_collision_for_enemy(self.rect.right, laser.rect.left,self.rect.left, laser.rect.right, laser,self.rect,laser.rect, scroll) and laser.is_enemy != True:
                    ...
                    self.kill()
                    print("D:/scrum-project-tr2-2024-strangers-group-2/final/main/Got hit!")


def is_collision_for_enemy(right, left, left1, right1, laser, rect1, rect2, scroll):
    # Ensure rect1 and rect2 are pygame.Rect objects
    if not isinstance(rect1, pygame.Rect) or not isinstance(rect2, pygame.Rect):
        raise TypeError("Expected pygame.Rect objects for rect1 and rect2")

    # Continue with the collision logic
    x1, y1, w1, h1 = rect1
    x2, y2, w2, h2 = rect2
    left -= scroll
    right1 -= scroll
...
common_height = 64
enemy_images = [
    r'D:/scrum-project-tr2-2024-strangers-group-2/final/main/img_character/enemy_sprite1.png',
    r'D:/scrum-project-tr2-2024-strangers-group-2/final/main/img_character/enemy_sprite2.png',
    r'D:/scrum-project-tr2-2024-strangers-group-2/final/main/img_character/enemy_sprite3.png',
    r'D:/scrum-project-tr2-2024-strangers-group-2/final/main/img_character/enemy_sprite4.png',
    r'D:/scrum-project-tr2-2024-strangers-group-2/final/main/img_character/enemy_sprite5.png',
    r'D:/scrum-project-tr2-2024-strangers-group-2/final/main/img_character/enemy_sprite6.png',
    r'D:/scrum-project-tr2-2024-strangers-group-2/final/main/img_character/enemy_sprite7.png'
]
...
def is_collision(right, left, left1, right1,laser, rect1, rect2, scroll, jump):
    ...
    top2 = y2
    bottom2 = y2 + h2
    # print("D:/scrum-project-tr2-2024-strangers-group-2/final/main/right of player ", right, " left of the laser ", left)
...
# Load player images
player_images = [
    r'D:/scrum-project-tr2-2024-strangers-group-2/final/main/img_character\Screenshot_2024-06-14_163851-removebg-preview.png', 
    r'D:/scrum-project-tr2-2024-strangers-group-2/final/main/img_character\Screenshot_2024-06-14_164717-removebg-preview.png',
    r'D:/scrum-project-tr2-2024-strangers-group-2/final/main/img_character\Screenshot_2024-06-14_164033-removebg-preview.png',
    r'D:/scrum-project-tr2-2024-strangers-group-2/final/main/img_character\Screenshot_2024-06-14_164605-removebg-preview.png',
    r'D:/scrum-project-tr2-2024-strangers-group-2/final/main/img_character\Screenshot_2024-06-14_164820-removebg-preview.png'
]
...
while running:
    ...
    # Check if player reaches the last block
    elif player.rect.right >= world.floor_list[-1].right + 800:
        game_win()

    else:
        draw_text("D:/scrum-project-tr2-2024-strangers-group-2/final/main/Press SPACE to pause", font, TEXT_COL, 412, 375)

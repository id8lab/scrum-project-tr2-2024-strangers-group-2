...
small_font = pygame.font.SysFont('comicsans', 20)  # Smaller font for the settings text
WHITE = (255, 255, 255)
timer = 0
player_lives = 3
level = 1
...
# Load and resize settings image
settings_image = pygame.image.load('seting.png').convert_alpha()
settings_size = (50, 50)
settings_image = pygame.transform.scale(settings_image, settings_size)
settings_rect = settings_image.get_rect(bottomright=(SCREEN_WIDTH - 10, SCREEN_HEIGHT - 10))
...
def draw_hud():
    ...
    # Draw "Start" text in the center of the screen
    start_text = font.render('Start', True, WHITE)
    start_rect = start_text.get_rect(center=(SCREEN_WIDTH // 2, SCREEN_HEIGHT // 2))
    screen.blit(start_text, start_rect)

    # Draw "Settings" text near the settings image in smaller font
    settings_text = small_font.render('Settings', True, WHITE)
    settings_text_rect = settings_text.get_rect(center=(settings_rect.centerx, settings_rect.centery - 30))
